...
<div class="login-card">
      <h1>Comment</h1><br>
      <form name = "input" action="contact2.php" method="post">
	    <input type="text" required  name="name" placeholder="Enter Name">
		<input type="text" required   name="email" placeholder="Enter Email-ID">
		<label><input type="tel" required name="phone" placeholder="Enter Mobile Number"></label>
        <label><textarea rows="7" cols="32" type="Message" required name="message" placeholder="Enter Message"></textarea></label>
        <input type="submit" name="submit" class="login login-submit" value="Send Message">
      </form>
    </div>	 
